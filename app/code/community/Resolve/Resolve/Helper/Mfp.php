...
/**
 * Class Resolve_Resolve_Helper_Mfp
 */
...
//    }
        ...
        if (null === $this->_categoryMfp) {
            $categories = Mage::getModel('catalog/category')->getCollection()
                ->addAttributeToSelect(
                    array('resolve_category_mfp', '', 'resolve_category_mfp_type', 'resolve_category_mfp_priority', 'resolve_category_mfp_startdate', 'resolve_category_mfp_end_date')
                )
    ...
    public function getMFPFromCategoriesALS(array $categoryItemsIds)
    {
        ...
        if(sizeof($newCategories)) {
            $categories = Mage::getModel('catalog/category')->getCollection()
                ->addAttributeToSelect(
                    array('resolve_category_promo_id', 'resolve_category_mfp_type', 'resolve_category_mfp_priority', 'resolve_category_mfp_startdate', 'resolve_category_mfp_end_date')
                )
