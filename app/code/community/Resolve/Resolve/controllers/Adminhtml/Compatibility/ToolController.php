 ...
 */
class Resolve_Resolve_Adminhtml_Compatibility_ToolController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Index action
     */
    ...
    {
        $this->_title($this->__('System'))->_title($this->__('Tools'))->_title($this->__('Resolve Compatibility Tool'));
    ...
    public function validateAction()
    {
        ...
        try {
            $validationEventResult = $this->getLayout()
                ->createBlock('resolve/adminhtml_compatibility_tool_event')->toHtml();
            $response->setValidationEventResult($validationEventResult);

            $validationClassResult = $this->getLayout()
                ->createBlock('resolve/adminhtml_compatibility_tool_classRewrites')->toHtml();
            $response->setValidationClassResult($validationClassResult);

            $validationCompilerResult = $this->getLayout()
                ->createBlock('resolve/adminhtml_compatibility_tool_compiler')->toHtml();
