<?php
class Resolve_Resolve_Model_Mysql4_Rule extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct()
    {    
        $this->_init('resolve/rule', 'rule_id');
    }
    ...
    public function getAttributes()
    {
        ...
        $tbl   = $this->getTable('resolve/attribute');
     ...
     * return Resolve_resolve_Model_Mysql4_Rule
     */
