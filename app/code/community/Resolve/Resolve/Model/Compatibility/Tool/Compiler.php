 ...
 */
class Resolve_Resolve_Model_Compatibility_Tool_Compiler extends Resolve_Resolve_Model_Compatibility_Tool_Entity_Abstract
{
    /**#@+
     * Define constants
     */
    ...
    const CACHE_KEY = 'RESOLVE_RESOLVE_COMPILER';
    /**#@-*/
    ...
    public function getCompilerControllerList()
    {
        ...
        if ($this->useCache() && $cache) {
            $controllersCompilerProblems = json_decode($cache, true);
        } else {
            ...
            if ($this->useCache()) {
                ...
                Mage::app()->saveCache(json_encode($controllersCompilerProblems),
